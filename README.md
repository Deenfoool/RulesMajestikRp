...
> 🗂️ Версия: 2.0 | 📅 Обновлено: Февраль 2026  
...
6. [⚖️ Уголовный кодекс](#-уголовный-кодекс)
7. [⚙️ Процессуальный кодекс](#-процессуальный-кодекс)
8. [💼 Трудовой кодекс](#-трудовой-кодекс)
...
```yaml
Стадия 1 - Присутствие:
  • Только присутствие сотрудника в форме
  • Достаточно для пресечения мелких правонарушений

Стадия 2 - Устные требования:
  • Внятные и структурированные требования
  • Указание на последствия

Стадия 3 - Простое силовое воздействие:
  • Заламывание рук, болевые точки
  • Дубинки, приёмы рукопашного боя
  • Контроль толпы

Стадия 4 - Нелетальное оружие:
  • Тазер (2 раза), резиновые пули
  • Слезоточивый газ, водомёты
  • Полицейские собаки
  ⚠️ Не применять к беременным, на воде, на возвышенности

Стадия 5 - Летальное оружие:
  • Огнестрельное оружие
  • Без предупредительных выстрелов
  
  Основания:
  • Защита жизни (себя или других)
  • Пресечение попытки завладения оружием
  • Освобождение заложников
  • Задержание вооружённого лица
  • Пресечение побега из-под стражи
  • Остановка ТС, создающего угрозу
```

### 🔹 Правило 21 фута (6 метров)
```
1м - Офицер не успеет среагировать на нож
2м - Успеет среагировать, но не достать оружие
3м - Успеет схватиться за кобуру
4м - Успеет расстегнуть кобуру
5м - Успеет достать пистолет и прицелиться
6м - Успеет начать стрелять и поразить цель
```
...
### 🔹 Основания для увольнения (работодатель)
```diff
+ Допустимо:
  ...
  • Повторная просроченная медкарта
  • Не прохождение стажировки
...
```yaml
Рабочая неделя: 7 календарных дней
Обеденный перерыв: 30 минут – 2 часа

Отпуск:
  • По уважительной причине: до 2 дней/месяц
  • За выдающиеся успехи: до 7 дней/месяц (по усмотрению)
  
Военнослужащих:
  • Увольнительное время (по званию и регламенту)
  • Может быть отозван в ЧС
```
...
Форма оплаты:
  • Почасовая оплата
  • Премии (по решению работодателя)

Выплата премий:
  • Зависит от отчётности
  • Выплачивается еженедельно
  • Может быть задержана при проблемах с казной
  • Только в валюте штата на личный счёт
```
...
По завершении:
  ...
  ✅ Право поступления в силовые структуры
```

### 🔹 Переводы между структурами
```yaml
Доступные переводы:
  LSPD ↔ LSCSD ↔ FIB ↔ SANG ↔ USSS (агентура)

Требования:
  • Одобрение обоих руководителей
  • Заполнение запроса на портале
  • Понижение не более чем на 5 позиций
  
Запрещено:
  • При расследовании (по решению прокуратуры/суда)
  • Восстановление в структуру после перевода
```
...
Просто скопируйте весь текст выше и вставьте в файл `README.md` вашего GitHub-репозитория. Документ оптимизирован для рендеринга на GitHub с поддержкой:
- 📑 Сворачиваемого оглавления
- 🎨 Цветового выделения (diff, yaml, bash)
- 📊 Таблиц и чек-листов
- 🔗 Внутренних якорных ссылок

Удачи в службе! 🪖✨
```

**Готово!** Теперь это полная версия 2.0 со всей информацией из:
- ✅ Уставов SANG
- ✅ Конституции штата
- ✅ Уголовного кодекса
...
Можете копировать и размещать на GitHub! 🚀
